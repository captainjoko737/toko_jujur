                            ...
                            <tbody>
                                @foreach ($result as $key => $value)
                                    <tr>
                                        ...
                                        <td>{{ $value['berat'] }}</td>
                                        <td>{{ $value['active'] }}</td>
                                        <td><a href="{{$value->photo}}" target="_blank" style="color:black;">{{ isset($value->photo) ? 'Click to View Photo!' : '' }}</a></td>
                                        <td>
                                            <a href="{{ route('barang.edit', ['id' => $value->id]) }}" data-toggle="tooltip" data-original-title="Edit" > <i class="fa fa-pencil text-inverse m-r-10"></i> </a>
